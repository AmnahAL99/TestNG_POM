...
public class BankManager extends BaseClass {
    ...
    public BankManager(WebDriver rdriver){
        ldriver = rdriver;
    ...
    public static List<Customer> inputData() {
        ...
        listCustomers.add(new Customer("Frank", "Minka", "M098Q585"));
        listCustomers.add(new Customer("Connely", "Christopher", "L789C349"));
...
//        listCustomers.add(new Customer("Jackson", "Connely", "L789C349"));
    ...
    public boolean verifyCustomerInserted() {
        ...
        for (Customer cust : inputData()) {
            ...
            present = listCustomer.stream().filter(i -> i.getFirstName().equals(cust.getFirstName()) && i.getLastName().equals(cust.getLastName()) && i.getPostCode().equals(cust.getPostCode())).findFirst().isPresent();
    ...
    public boolean deleteCustomers() throws Exception {
        ...
        for (Customer cust : customersToDelete()) {
            for (int row = 1; row <= listOfRows.size(); row++) {
                ...
                if (cust.getFirstName().equalsIgnoreCase(actualfirstname) && cust.getLastName().equalsIgnoreCase(actuallastname) && cust.getPostCode().equalsIgnoreCase(actualpostcode)) {
                    ...
                    System.out.println("Customer deleted: " + cust.getFirstName() + " " + cust.getLastName() + ", " + cust.getPostCode());
                    return true; // Deletion successful
                }
            }
        }
        System.out.println("No customers found for deletion");
        return false; // Deletion not successful
    }
